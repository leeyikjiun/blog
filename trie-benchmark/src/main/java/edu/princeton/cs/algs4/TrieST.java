...
public class TrieST<Value> {
     ...
     * value if the key is already in the symbol table. If the value is <tt>null</tt>, this
     ...
     * @return all of the keys in the symbol table that match <tt>pattern</tt>, as an iterable,
